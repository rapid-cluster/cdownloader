...
#ifndef CDOWNLOAD_CSA_CHUNK_DOWNLOADER_HXX
#define CDOWNLOAD_CSA_CHUNK_DOWNLOADER_HXX
...
namespace csa {
	...
	public:
		ChunkDownloader(const path& tmpDir, const path& unpackedDataDir, DataDownloader& downloader,
		...
		void setTimeRange(const datetime& startTime, const datetime& endTime);
	private:
		std::map<std::string, DownloadedChunkFile>
...
#endif // CDOWNLOAD_CSA_CHUNK_DOWNLOADER_HXX
